...
namespace ProgrammingAssignment4
{
    ...
    public class BoardSquare
    {
        ...
        public bool Update(MouseState mouse)
        {
            ...
            if (mouse.X > drawRectangle.X && mouse.X < drawRectangle.X + drawRectangle.Width &&
                mouse.Y > drawRectangle.Y && mouse.Y < drawRectangle.Y + drawRectangle.Height &&
                 mouse.LeftButton == ButtonState.Pressed && Contents == SquareContents.Empty)
             {
